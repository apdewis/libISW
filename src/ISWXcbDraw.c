...
#include "../include/X11/Xaw3d/XawXftCompat.h"  /* For ISWFontSet definition */
 ...
 */
int
XawTextWidth(ISWFontSet *fontset, const char *text, int len)
{
...
{
    ISWRegionPtr region = (ISWRegionPtr)calloc(1, sizeof(XawRegion));
    return region;
}
