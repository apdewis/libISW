/*
 * IswDrawing.c - XCB-based drawing utilities for Isw3d
 * 
...
#if 0
/*
 * IswCreateStippledPixmap - Create a 50% gray stippled pixmap
 *
 ...
 */
void
ISWReleaseStippledPixmap(xcb_screen_t *screen, xcb_pixmap_t pixmap)
{
    xcb_connection_t *dpy;
...
/* ISWDistinguishablePixels - DUPLICATE - Commented out to avoid linker conflict
 * This function is now implemented in IswXcbDraw.c */
#if 0
/*
 * ISWDistinguishablePixels - Determine if pixels are visually distinct
 *
...
#endif /* 0 - ISWDistinguishablePixels */

/* XmuCreateStippledPixmap - DUPLICATE - Commented out to avoid linker conflict
 * This function is now implemented in IswXcbDraw.c */
#if 0
/*
 * XmuCreateStippledPixmap - Compatibility alias for IswCreateStippledPixmap
 *
 ...
 * 1. IswContext to map Screen -> Display
